/**
 * Implements lazy initialization for getter or memoization of a function call.
...
export function makePure<T>(
    ...
    if (typeof value !== 'function') {
        throw new Error('makePure can only be used with getters or functions');
    }
    ...
    return {
        ...
        get(): T {
            ...
            const patched = (...args: Array<unknown>) => {
                ...
                previousArgs = args;
                previousResult = originalValue.apply(this, args);
